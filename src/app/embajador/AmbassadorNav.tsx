 ...
 * tabs arriba en desktop y barra fija abajo en móvil.
 */
const ITEMS = [
  { href: "/embajador", icon: "🏠", label: "Resumen", short: "Resumen" },
  { href: "/embajador/metricas", icon: "📈", label: "Métricas", short: "Métricas" },
  { href: "/embajador/materiales", icon: "🖼️", label: "Materiales", short: "Materiales" },
  { href: "/embajador/cuenta", icon: "⚙️", label: "Mi cuenta", short: "Cuenta" },
] as const;
