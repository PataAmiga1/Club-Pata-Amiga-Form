...
export const REPORTES: ReporteExportable[] = [
  {
    ...
    columnas: [
      ...
      { key: "membresia", label: "Membresía de este cobro ($159 o $599)", grupo: "Cobro", porOmision: true },
      { key: "peludo", label: "Peludo de este cobro ($599)", grupo: "Cobro" },
  ...
  },
  {
    ...
    columnas: [
      ...
      { key: "plan", label: "Plan", grupo: "Membresía", porOmision: true },
      { key: "membresia", label: "Membresía ($159 o $599)", grupo: "Membresía", porOmision: true },
      { key: "monto_plan", label: "Monto del plan (con varios peludos, la suma)", grupo: "Membresía" },
      { key: "peludos_con_membresia", label: "Peludos con membresía $599", grupo: "Membresía" },
      { key: "ingreso_mensual", label: "Ingreso mensual (anual ÷ 12)", grupo: "Membresía" },
